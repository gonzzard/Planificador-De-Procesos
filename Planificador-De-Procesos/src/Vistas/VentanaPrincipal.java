...
public class VentanaPrincipal extends javax.swing.JFrame
{
    ...
    public void crearGraficaTiemposEspera() throws IOException
    {
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();

        for (int i = 0; i < procesos.size(); i++)
        {
            dataset.addValue(procesos.get(i).tiempoDeEsperaAcum, "P", "P" + (i+1));
        }
        ...
        File BarChart = new File("TiemposDeEspera.jpeg");
